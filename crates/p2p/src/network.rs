...
/// Follower-to-leader settlement signature or terminal refusal channel.
pub(crate) const SIGNING_RESPONSE_CHANNEL: u64 = 4;
pub(crate) const BLOCK_BACKLOG: usize = 8;
