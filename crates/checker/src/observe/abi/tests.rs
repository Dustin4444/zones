...
#[test]
fn advance_tempo_selectors_match_literal_vectors() {
    assert_eq!(
...
#[test]
fn single_header_call_normalizes_to_one_imported_header() {
    let decoded = decode_advance(&single_header_advance_call()).unwrap();
