...
use crate::utils::{
    ...
    WithdrawalArgs, ZoneAccount, ZoneCreationConfig, ZoneTestNode, spawn_sequencer,
};
use alloy::{
...
use tempo_zone_contracts::{
    TEMPO_STATE_ADDRESS, TempoState, ZONE_TOKEN_ADDRESS, ZoneAccessMode, ZonePortal,
    ZonePortal::Role as PortalRole,
};
...
async fn test_encrypted_deposit_blacklisted_recipient() -> eyre::Result<()> {
    ...
    let _sequencer = spawn_sequencer(&l1, &zone, portal_address, sequencer_signer.clone()).await;
