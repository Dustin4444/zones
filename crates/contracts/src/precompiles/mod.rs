...
pub use zone_primitives::constants::{
    ...
    PORTAL_ENFORCEMENT_FLAGS_SLOT, PORTAL_GATEWAY_MODE_SLOT, PORTAL_PENDING_SEQUENCER_SLOT,
    PORTAL_ROLE_SLOT, PORTAL_SEQUENCER_SLOT, TEMPO_STATE_ADDRESS, ZONE_CONFIG_ADDRESS,
