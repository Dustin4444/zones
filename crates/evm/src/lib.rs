...
use crate::precompiles::{
    ...
    L1State, L1StorageReader, TIP403_REGISTRY_ADDRESS, TempoState, WithdrawalTracker,
...
use tempo_zone_contracts::{
    TEMPO_STATE_ADDRESS, WITHDRAWAL_TRACKER_ADDRESS, ZONE_OUTBOX_ADDRESS, ZONE_TX_CONTEXT_ADDRESS,
};
    ...
    L1: L1StorageReader,
{
    ...
    fn register_precompiles<DB: Database, I: Inspector<TempoCtx<L1OverlayDB<DB, L1>>>>(
        ...
        precompiles.apply_precompile(&WITHDRAWAL_TRACKER_ADDRESS, |_| {
            Some(WithdrawalTracker::create(&env))
        });
