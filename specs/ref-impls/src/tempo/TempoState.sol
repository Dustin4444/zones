...
contract TempoState is ITempoState {
    ...
    function finalizeTempo(bytes calldata header) external {
        ...
        // The native implementation additionally proves on the first import that the portal's
        // admin slot is non-zero against the header's state root. This Solidity reference
        // cannot perform native Tempo-state reads and models only the checkpoint rules.
